...
import utilidades.SecretarioUtilidades;
...
public class AddSecretarioServlet extends HttpServlet {
...
//		Key clave = KeyFactory.stringToKey(req.getParameter("clave"));
		...
		SecretarioUtilidades.add(nombres,ap_paterno,ap_materno,dni,correo,tipo,condicion);
